...
import {
  Activity, BadgeCheck, Ban, Globe2, Mail, ShieldAlert, Ticket, TrendingUp,
} from "lucide-react";
            ...
            <SheetHeader className="space-y-0 border-b border-border px-5 py-4">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <SheetTitle className="truncate font-display text-lg">{affiliate.display_name}</SheetTitle>
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2">
                    <StatusBadge
                      tone={
                        /verified|active/i.test(affiliate.status) ? "success"
                        : /pending/i.test(affiliate.status) ? "warning"
                        : /suspend|reject/i.test(affiliate.status) ? "destructive" : "neutral"
                      }
                    >
                      {affiliate.status}
                    </StatusBadge>
