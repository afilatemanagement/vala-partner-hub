            ...
            {actions.map((a) => {
              ...
              return (
                <button
                  key={a.id}
                  onClick={() => setActive(a)}
                  className="group flex flex-col items-stretch gap-3 rounded-lg border border-border bg-surface p-4 text-left transition-colors hover:border-border-strong hover:bg-muted/30"
                >
